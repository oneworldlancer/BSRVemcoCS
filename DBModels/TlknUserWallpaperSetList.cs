...
public partial class TlknUserWallpaperSetList
{
    public long UwallpaperSetId { get; set; }
    ...
    public string? WallpaperSetTitle { get; set; }

    public string? WallpaperSetDescription { get; set; }
