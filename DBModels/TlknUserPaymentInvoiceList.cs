...
public partial class TlknUserPaymentInvoiceList
{
    public long UinvoiceId { get; set; }
    ...
    public DateTime? InvoiceRequestTimeoutStartDateTime { get; set; }

    public DateTime? InvoiceRequestTimeoutEndDateTime { get; set; }

    public DateTime? InvoiceRequestCancelDateTime { get; set; }
