...
public partial class TlknUserStickerSetList
{
    ...
    public string? StickerCategoryCode { get; set; }

    public string? StickerCategoryMiniDescription { get; set; }

    public string? StickerCategoryFullDescription { get; set; }

    public string? StickerCategoryName { get; set; }

    public string? StickerCategoryTitle { get; set; }

    public string? StickerCategoryDescription { get; set; }
