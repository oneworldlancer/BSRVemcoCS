...
public partial class BsrvemcoUserScreenChatShowShareAudio
{
    ...
    public string? AudioTokenId { get; set; }
    ...
    public string? AudioThumImageMimeType { get; set; }

    public byte[]? AudioThumImageData { get; set; }
    ...
    public string? AudioThmUrl { get; set; }
