...
public partial class BsrvemcoUserMobileNumberList
{
    ...
    public virtual ICollection<TlknUserGroupshowFavorite> TlknUserGroupshowFavorites { get; set; } = new List<TlknUserGroupshowFavorite>();
}
