...
public partial class TlknUserWallpaperCountList
{
    public long UwallpaperCountId { get; set; }
    ...
    public string? WallpaperSetCount { get; set; }
    ...
    public string? IwallpapermageSmallUrl { get; set; }
