...
public partial class TlknUserBroadcastPrivateshowVideoList
{
    public long UprivateShowVideoId { get; set; }
    ...
    public string? EndDateTimeMilliSec { get; set; }
    ...
    public bool? IsVideoSaveLive { get; set; }

    public bool? IsVideoTopFirstLive { get; set; }

    public DateTime? VideoTopFirstLiveOrder { get; set; }
