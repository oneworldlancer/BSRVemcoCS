...
{
    public class AppDevelomentInformationQueryViewModel
    {
        //[Required]
        ...
        public List<AppUserBuildingQueryInformationTableModelManager>? BuildingInformationQueryTableList { get; set; } = new List<AppUserBuildingQueryInformationTableModelManager> ( );
