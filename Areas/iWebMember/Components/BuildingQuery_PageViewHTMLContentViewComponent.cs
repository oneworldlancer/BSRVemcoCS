...
{
    public class BuildingQuery_PageViewHTMLContentViewComponent : ViewComponent
    {
        ...
        public BuildingQuery_PageViewHTMLContentViewComponent(BSRDBModelContext dbContext,
