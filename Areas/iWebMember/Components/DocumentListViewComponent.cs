...
namespace BSRVemcoCS.Areas.iWebMember.Components
{
    public class DocumentListViewComponent : ViewComponent
    {
        ...
        public DocumentListViewComponent(BSRDBModelContext dbContext,
                ...
                if (_arrInfomationDocumentList != null)
                {
                    for (int i = 0; i < _arrInfomationDocumentList.Count; i++)
                    {
                        _iDocumentViewModel = new AppUserBuildingInformationDocumentModelManager()
                        {
                            ...
                            DocumentWebURL = _arrInfomationDocumentList[i].DocumentWebUrl.ToLower(),
                            ...
                            TimeframeMonth = _arrInfomationDocumentList[i].TimeframeMonthCount,
